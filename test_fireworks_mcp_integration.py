    ...
    for model_name, model_id in models_to_test:
        ...
        try:
            ...
            if agent.is_configured():
                ...
                results[model_name] = {"success": False, "error": "Agent not configured"}
    ...
    if fireworks_agent.is_configured():
        try:
            ...
            if fireworks_result["success"]:
                print(f"✅ FIREWORKS: {len(fireworks_result['agent_response'])} characters")
            else:
        ...
        try:
            ...
            if anthropic_agent.agent:
                ...
                if anthropic_result["success"]:
                    print(f"✅ Anthropic: {len(anthropic_result['agent_response'])} characters")
                else:
