...
class TestEnvelopeAgentIntegration:
    ...
    async def test_agent_envelope_understanding(self):
        ...
        result = await agent.run(
            """
        Please load the LoadSet data from 'solution/loads/new_loads.json' and explain:
    ...
    async def test_agent_envelope_explanation(self):
        ...
        Then demonstrate by loading 'solution/loads/new_loads.json' and creating an envelope.
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        try:
            ...
            result = await agent.run(
                """
                Load 'solution/loads/new_loads.json', create an envelope, 
