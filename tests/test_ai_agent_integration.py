...
class AnthropicMCPTestAgent:
    ...
    def _register_tools(self):
        ...
        def convert_units(target_units: str) -> dict:
            ...
            return self.call_tool_directly("convert_units", target_units=target_units)["tool_result"]
        ...
        def export_to_ansys(folder_path: str, name_stem: str) -> dict:
            ...
            return self.call_tool_directly("export_to_ansys", folder_path=folder_path, name_stem=name_stem)["tool_result"]
    ...
    async def process_user_prompt(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "tool_calls": [msg for msg in result.all_messages() if hasattr(msg, 'tool_calls')]
            }
    ...
    async def load_and_process_workflow(self, json_path: str, target_units: str, scale_factor: float, output_folder: str) -> Dict[str, Any]:
        """
...
class TestAnthropicAgentIntegration:
    ...
    def validate_ansys_files(self, output_folder: Path, expected_load_cases: int) -> bool:
        """
    ...
    def validate_unit_conversion(self, original_value: float, converted_value: float, factor: float, unit_conversion_factor: float) -> bool:
        """
    ...
    async def test_anthropic_agent_full_workflow(self):
        ...
        assert result["success"], f"Agent workflow failed: {result.get('error', 'Unknown error')}"
        ...
        assert "fx," in content or "fy," in content or "fz," in content, "ANSYS file does not contain force commands"
    ...
    def test_output_validation(self):
        ...
        assert "fx," in content or "fy," in content or "fz," in content, "ANSYS file missing force commands"
