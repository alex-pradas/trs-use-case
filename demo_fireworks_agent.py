...
async def main():
    ...
    if successful_demos == total_demos:
        print("🎉 All demos successful! FIREWORKS AI is ready for aerospace load processing.")
    elif successful_demos > 0:
        print("⚠️  Some demos successful. FIREWORKS integration is working but may need refinement.")
    else:
