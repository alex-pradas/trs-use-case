...
async def main():
    ...
    if history['success']:
        ...
        for i, entry in enumerate(executions, 1):
            ...
            if entry['stdout'] and entry['success']:
                print("Output:")
                print(entry['stdout'][:500] + ("..." if len(entry['stdout']) > 500 else ""))
    ...
    if variables['success']:
        ...
        loadset_vars = [v for v in var_names if 'load' in v.lower() and 'LoadSet' in variables['tool_result']['variables'][v]['type']]
            ...
            for var in loadset_vars[:1]:  # Just show first one
                ...
                if var_detail['success']:
                    ...
                    if 'shape' in var_detail['tool_result']['variable_info']:
                        print(f"  Shape: {var_detail['tool_result']['variable_info']['shape']}")
