...
def load_inputs() -> Dict[str, Any]:
    ...
    # Load input mappings
    # Load loadset_file from inputs/primary_loadset.json
    with open(Path("inputs/primary_loadset.json"), "r") as f:
...
def save_outputs(outputs: Dict[str, Any]) -> None:
    ...
    # Save loadset to primary_loadset.json
    with open(OUTPUT_DIR / "primary_loadset.json", "w") as f:
        json.dump(outputs["loadset"], f, indent=2)


def main() -> None:
    """Main execution function."""
    logger.info("Starting step 01: load_primary_loadset")
