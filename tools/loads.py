...
class LoadSet(BaseModel):
    ...
    def convert_to(self, units: ForceUnit) -> "LoadSet":
        ...
        for load_case in self.load_cases:
            ...
            for point_load in load_case.point_loads:
                ...
                new_point_loads.append(PointLoad(
                    name=point_load.name,
                    force_moment=new_force_moment
                ))
            
            new_load_cases.append(LoadCase(
                name=load_case.name,
    ...
    def _generate_ansys_content(self, load_case: LoadCase) -> str:
        ...
        lines.append(f"! Units: Forces={self.units.forces}, Moments={self.units.moments}")
        lines.append("!")
