    ...
    def __init__(self, mcp_server, output_directory: Optional[Path] = None):
        ...
        if os.getenv("ANTHROPIC_API_KEY"):
            try:
                ...
                print(
                    "Warning: pydantic-ai not available. Agent functionality will be limited."
                )
                self.agent = None
...
"""
    ...
    def _register_tools(self):
        ...
        def download_file(file_path: str, encoding: str = "base64") -> dict:
            ...
            return self.call_tool_directly(
                "download_file", file_path=file_path, encoding=encoding
            )["tool_result"]
        ...
        def upload_file(file_path: str, content: str, encoding: str = "base64") -> dict:
            ...
            return self.call_tool_directly(
                "upload_file", file_path=file_path, content=content, encoding=encoding
            )["tool_result"]
        ...
        def reset_workspace(cleanup_current: bool = True) -> dict:
            ...
            return self.call_tool_directly(
                "reset_workspace", cleanup_current=cleanup_current
            )["tool_result"]
    ...
    async def generate_loadset_processing_script(
        self, input_file: str, operations: List[str], output_format: str = "ansys"
    ) -> Dict[str, Any]:
        """
